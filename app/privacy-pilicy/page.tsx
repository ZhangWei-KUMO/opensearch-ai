...
const content = `
 ...
 Welcome to TubeXChat, Inc. (hereinafter referred to as "TubeX") operates the TubeX.AI service as one of its products. 
 Throughout this Privacy Policy, references to "TubeX," "TubeX.AI," "we," "us," "our," and similar terms refer to TubeXChat and its affiliates, 
 including but not limited to TubeX.AI. By using the TubeX.AI service, you acknowledge and agree that TubeXChat is the entity responsible for the collection, 
 use, and protection of your personal information as described in this Privacy Policy.

Please carefully read this Policy before you use or submit any information through or in connection with the Services.
 ...
 Unless otherwise required by laws in your residence, by using our Services, you accept our privacy practices described in this Policy.
...
* Content you provide through our products: As part of the service, we collect and store the content you post, send, receive, and share through our product. This includes any data you enter in any "free text" box on our product, as well as files and links you upload to the service. Examples of the content we collect and store include: applications you create in TubeX.AI, descriptions of application-related commands, links to access applications, links to privacy policies for applications, or any other information you provide.
...
* Communicate with you about promotions, upcoming events, and other news about products and services offered by TubeXChat and our partners.
...
## How to contact us?
Your information is controlled by TubeXChat. If you have questions or concerns about how your information is handled, please direct your inquiry to TubeXChat, which is responsible for facilitating such inquiries.

TubeXChat, Inc., 2315 Ashby Avenue,Berkeley,CA94705, USA.
